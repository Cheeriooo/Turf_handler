...
const MatchSetup: React.FC<MatchSetupProps> = ({ onMatchStart }) => {
  ...
  const renderTeamCard = (
    ...
    <div className="bg-[#161B22] p-5 rounded-xl space-y-4 shadow-lg border-transparent">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="text-center py-4">
            ...
            <input
              ...
              className="w-32 p-3 text-center text-xl font-bold bg-[#161B22] border border-gray-700 rounded-lg focus:ring-2 focus:ring-[#3B82F6] outline-none text-white"
              min="1"
              max="50"
              required
            />
